...
export class CreateRiesgosTrabajoDto {
  ...
  @Type(() => Date)
  @IsNotEmpty({
    message: 'La fecha del riesgo de trabajo no puede estar vacía',
  })
  fechaRiesgo: Date;
  ...
  @IsEnum(siNO, {
    message: `La recaída debe ser uno de los siguientes: ${siNO.join(', ')}`,
  })
  recaida?: string;
  ...
  @IsString({
    message:
      'El identificador de seguridad social debe ser una cadena de texto',
  })
  // Permitir 4-30 alfanumérico y separadores comunes
  // Nota: Se valida en servicio de trabajadores también
  @Length(4, 30, {
    message: 'El identificador debe tener entre 4 y 30 caracteres',
  })
  NSS?: string;

  @IsOptional()
  @IsString({ message: 'El tipo de riesgo debe ser una cadena de texto' })
  @IsEnum(tiposDeRiesgo, {
    message: `El tipo de riesgo debe ser uno de los siguientes: ${tiposDeRiesgo.join(', ')}`,
  })
  tipoRiesgo?: string;

  @IsOptional()
  @IsString({
    message: 'La naturaleza de la lesión debe ser una cadena de texto',
  })
  naturalezaLesion?: string;

  @IsOptional()
  @IsString({
    message: 'La parte del cuerpo afectada debe ser una cadena de texto',
  })
  ...
  @IsEnum(tiposManejo, {
    message: `El manejo debe ser uno de los siguientes: ${tiposManejo.join(', ')}`,
  })
  manejo?: string;
  ...
  @IsEnum(tipoAlta, {
    message: `El tipo de alta debe ser uno de los siguientes: ${tipoAlta.join(', ')}`,
  })
  alta?: string;
  ...
  @IsNumber(
    {},
    { message: 'Los días de incapacidad deben ser un número entero' },
  )
  ...
  @IsEnum(siNO, {
    message: `Las secuelas deben ser uno de los siguientes: ${siNO.join(', ')}`,
  })
  secuelas?: string;
