...
import { InformePersonalizacion, InformePersonalizacionSchema } from './schemas/informe-personalizacion.schema';

@Module({
  imports: [
    MongooseModule.forFeature([
      { name: InformePersonalizacion.name, schema: InformePersonalizacionSchema },
    ]),
  ],
