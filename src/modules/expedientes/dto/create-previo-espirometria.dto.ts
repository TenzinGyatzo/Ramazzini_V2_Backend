...
export class CreatePrevioEspirometriaDto {
  ...
  @Type(() => Date)
  @IsNotEmpty({
    message: 'La fecha del previo espirometría no puede estar vacía',
  })
  ...
  @IsEnum(tabaquismoOpciones, {
    message:
      'El tabaquismo debe ser uno de los siguientes: ' + tabaquismoOpciones,
  })
  tabaquismo: string;
  ...
  @IsOptional()
  @IsEnum(cigarrosSemanaOpciones, {
    message:
      'Los paquetes-año deben ser uno de los siguientes: ' +
      cigarrosSemanaOpciones,
  })
  ...
  @IsNotEmpty({
    message: 'La exposición a humos de biomasa no puede estar vacía',
  })
  @IsEnum(siONo, {
    message:
      'La exposición a humos de biomasa debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsNotEmpty({
    message: 'La exposición laboral a polvos no puede estar vacía',
  })
  @IsEnum(siONo, {
    message:
      'La exposición laboral a polvos debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsString({
    message: 'La exposición a vapores o gases irritantes debe ser un string',
  })
  @IsNotEmpty({
    message: 'La exposición a vapores o gases irritantes no puede estar vacía',
  })
  @IsEnum(siONo, {
    message:
      'La exposición a vapores o gases irritantes debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @ApiProperty({
    description:
      'Antecedentes de tuberculosis u otras infecciones respiratorias',
    enum: siONo,
    example: 'No',
  })
  @IsString({
    message:
      'Los antecedentes de tuberculosis u otras infecciones respiratorias deben ser un string',
  })
  @IsNotEmpty({
    message:
      'Los antecedentes de tuberculosis u otras infecciones respiratorias no pueden estar vacíos',
  })
  @IsEnum(siONo, {
    message:
      'Los antecedentes de tuberculosis u otras infecciones respiratorias deben ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'La tos crónica debe ser uno de los siguientes: ' + siONo,
  })
  tosCronica: string;
  ...
  @IsEnum(siONo, {
    message:
      'La expectoración frecuente debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(disneaOpciones, {
    message: 'La disnea debe ser uno de los siguientes: ' + disneaOpciones,
  })
  disnea: string;
  ...
  @IsEnum(siONo, {
    message: 'Las sibilancias deben ser uno de los siguientes: ' + siONo,
  })
  sibilancias: string;
  ...
  @IsEnum(siONo, {
    message: 'La hemoptisis debe ser uno de los siguientes: ' + siONo,
  })
  hemoptisis: string;
  ...
  @IsEnum(siONo, {
    message: 'El asma debe ser uno de los siguientes: ' + siONo,
  })
  asma: string;
  ...
  @IsEnum(siONo, {
    message:
      'La EPOC / Bronquitis crónica debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'La fibrosis pulmonar debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'La apnea del sueño debe ser uno de los siguientes: ' + siONo,
  })
  apneaSueno: string;

  @ApiProperty({
    description:
      'Medicamentos actuales (broncodilatadores, corticoides, otros)',
    enum: siONo,
    example: 'No',
  })
  ...
  @IsEnum(siONo, {
    message:
      'Los medicamentos actuales deben ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsString({
    message: 'La especificación de medicamentos actuales debe ser un string',
  })
  @IsOptional()
  ...
  @IsEnum(siONo, {
    message: 'La cirugía reciente debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsNotEmpty({
    message: 'La infección respiratoria activa no puede estar vacía',
  })
  @IsEnum(siONo, {
    message:
      'La infección respiratoria activa debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'El embarazo complicado debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'El derrame pleural debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'El neumotórax debe ser uno de los siguientes: ' + siONo,
  })
  neumotorax: string;
  ...
  @IsString({
    message: 'El infarto agudo / angina inestable debe ser un string',
  })
  @IsNotEmpty({
    message: 'El infarto agudo / angina inestable no puede estar vacío',
  })
  @IsEnum(siONo, {
    message:
      'El infarto agudo / angina inestable debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(siONo, {
    message:
      'El aneurisma aórtico conocido debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsString({
    message: 'La inestabilidad hemodinámica grave debe ser un string',
  })
  @IsNotEmpty({
    message: 'La inestabilidad hemodinámica grave no puede estar vacía',
  })
  @IsEnum(siONo, {
    message:
      'La inestabilidad hemodinámica grave debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(siONo, {
    message:
      'La hipertensión intracraneal debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsString({
    message: 'El desprendimiento agudo de retina debe ser un string',
  })
  @IsNotEmpty({
    message: 'El desprendimiento agudo de retina no puede estar vacío',
  })
  @IsEnum(siONo, {
    message:
      'El desprendimiento agudo de retina debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(resultadoCuestionarioOpciones, {
    message:
      'El resultado de cuestionario debe ser uno de los siguientes: ' +
      resultadoCuestionarioOpciones,
  })
  resultadoCuestionario: string;

  @ApiProperty({
    description:
      'Resultado de cuestionario personalizado (cuando se selecciona OTRO)',
    example: 'Requiere evaluación adicional por especialista',
  })
  @IsString({
    message: 'El resultado de cuestionario personalizado debe ser un string',
  })
  @IsOptional()
  ...
  @IsString({
    message: 'La ruta del PDF del previo espirometría debe ser un string',
  })
  @IsNotEmpty({
    message: 'La ruta del PDF del previo espirometría no puede estar vacía',
  })
  rutaPDF: string;
