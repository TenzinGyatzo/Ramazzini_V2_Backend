...
import { IsDate, IsMongoId, IsNotEmpty, IsOptional, IsString, IsNumber } from "class-validator";
...
export class CreateControlPrenatalDto {
    ...
    @IsDate({ message: 'La fecha de inicio del control prenatal debe ser una fecha' })
    @Type(() => Date)
    @IsNotEmpty({ message: 'La fecha de inicio del control prenatal no puede estar vacía' })
    ...
    @IsOptional()
    @IsNumber({}, { message: 'Edad de la primera menstruación debe ser un número' })
    menarca?: number;
    ...
    @IsOptional()
    @IsString({ message: 'Características del ciclo menstrual debe ser un string' })
    ciclos?: string;
    ...
    @IsOptional()
    @IsNumber({}, { message: 'Inicio de Vida Sexual Activa (edad) debe ser un número' })
    ivsa?: number;
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en enero', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de enero debe ser un número' })
    eneroFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en enero', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en febrero', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de febrero debe ser un número' })
    febreroFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en febrero', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'SDG de febrero debe ser un número' })
    febreroSdg?: number;

    @ApiProperty({ description: 'Fondo uterino en febrero (cm)', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en marzo', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de marzo debe ser un número' })
    marzoFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en marzo', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en abril', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de abril debe ser un número' })
    abrilFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en abril', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en mayo', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en junio', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de junio debe ser un número' })
    junioFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en junio', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en julio', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de julio debe ser un número' })
    julioFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en julio', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en agosto', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de agosto debe ser un número' })
    agostoFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en agosto', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Fecha del control de septiembre', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Tensión arterial en septiembre', required: false })
    @IsOptional()
    @IsString({ message: 'Tensión arterial de septiembre debe ser un string' })
    septiembreTia?: string;

    @ApiProperty({ description: 'Frecuencia cardíaca fetal en septiembre', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de septiembre debe ser un número' })
    septiembreFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en septiembre', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'SDG de septiembre debe ser un número' })
    septiembreSdg?: number;

    @ApiProperty({ description: 'Fondo uterino en septiembre (cm)', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Frecuencia cardíaca fetal en octubre', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de octubre debe ser un número' })
    octubreFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en octubre', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'SDG de octubre debe ser un número' })
    octubreSdg?: number;

    @ApiProperty({ description: 'Fondo uterino en octubre (cm)', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'Fondo uterino de octubre debe ser un número' })
    octubreFondoUterino?: number;

    // Seguimiento mensual - Noviembre
    @ApiProperty({ description: 'Fecha del control de noviembre', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Tensión arterial en noviembre', required: false })
    @IsOptional()
    @IsString({ message: 'Tensión arterial de noviembre debe ser un string' })
    noviembreTia?: string;

    @ApiProperty({ description: 'Frecuencia cardíaca fetal en noviembre', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de noviembre debe ser un número' })
    noviembreFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en noviembre', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'SDG de noviembre debe ser un número' })
    noviembreSdg?: number;

    @ApiProperty({ description: 'Fondo uterino en noviembre (cm)', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'Fondo uterino de noviembre debe ser un número' })
    noviembreFondoUterino?: number;

    // Seguimiento mensual - Diciembre
    @ApiProperty({ description: 'Fecha del control de diciembre', required: false })
    @IsOptional()
    ...
    @ApiProperty({ description: 'Tensión arterial en diciembre', required: false })
    @IsOptional()
    @IsString({ message: 'Tensión arterial de diciembre debe ser un string' })
    diciembreTia?: string;

    @ApiProperty({ description: 'Frecuencia cardíaca fetal en diciembre', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'FCF de diciembre debe ser un número' })
    diciembreFcf?: number;

    @ApiProperty({ description: 'Semanas de gestación en diciembre', required: false })
    @IsOptional()
    @IsNumber({}, { message: 'SDG de diciembre debe ser un número' })
    diciembreSdg?: number;

    @ApiProperty({ description: 'Fondo uterino en diciembre (cm)', required: false })
    @IsOptional()
    ...
    @ApiProperty({
        description: 'Observaciones sobre la evolución del peso a lo largo del tiempo',
    ...
    @ApiProperty({
        description: 'Observaciones sobre la evolución del IMC a lo largo del tiempo',
    ...
    @ApiProperty({
        description: 'Observaciones sobre la evolución de la tensión arterial a lo largo del tiempo',
        example: 'Tensión arterial controlada, sin signos de preeclampsia',
        required: false
    })
    @IsOptional()
    @IsString({ message: 'Observaciones de la tensión arterial debe ser un string' })
    observacionesTia?: string;

    @ApiProperty({
        description: 'Observaciones sobre la evolución de la frecuencia cardíaca fetal a lo largo del tiempo',
    ...
    @ApiProperty({
        description: 'Observaciones sobre la evolución de las semanas de gestación a lo largo del tiempo',
    ...
    @ApiProperty({
        description: 'Observaciones sobre la evolución del fondo uterino a lo largo del tiempo',
    ...
    @IsOptional()
    @IsString({ message: 'La ruta del PDF del control prenatal debe ser un string' })
    rutaPDF?: string;
