...
export class CreateHistoriaClinicaDto {
  ...
  @IsEnum(motivoExamen, {
    message:
      'El motivo del examen debe ser alguno de los siguientes: ' + motivoExamen,
  })
  motivoExamen: string;
  ...
  @IsOptional()
  @IsString({
    message: 'actividadFisicaDeficienteEspecificar debe ser un string',
  })
  ...
  @IsOptional()
  @IsString({
    message: 'higienePersonalDeficienteEspecificar debe ser un string',
  })
  higienePersonalDeficienteEspecificar: string;

  // Antecedentes Ginecoobstetricos
  @IsOptional()
  @IsEnum(menarcaOpciones, {
    message:
      'menarca debe ser alguna de las siguientes opciones: ' + menarcaOpciones,
  })
  menarca: string;

  @IsOptional()
  @IsEnum(duracionOpciones, {
    message:
      'duracionPromedio debe ser alguna de las siguientes opciones: ' +
      duracionOpciones,
  })
  duracionPromedio: string;

  @IsOptional()
  @IsEnum(frecuenciaOpciones, {
    message:
      'frecuencia debe ser alguna de las siguientes opciones: ' +
      frecuenciaOpciones,
  })
  frecuencia: string;

  @IsOptional()
  @IsEnum(gestasOpciones, {
    message:
      'gestas debe ser alguna de las siguientes opciones: ' + gestasOpciones,
  })
  gestas: string;

  @IsOptional()
  @IsEnum(partosOpciones, {
    message:
      'partos debe ser alguna de las siguientes opciones: ' + partosOpciones,
  })
  partos: string;

  @IsOptional()
  @IsEnum(cesareasOpciones, {
    message:
      'cesareas debe ser alguna de las siguientes opciones: ' +
      cesareasOpciones,
  })
  cesareas: string;

  @IsOptional()
  @IsEnum(abortosOpciones, {
    message:
      'abortos debe ser alguna de las siguientes opciones: ' + abortosOpciones,
  })
  abortos: string;
  ...
  @IsOptional()
  @IsEnum(dolorMenstrualOpciones, {
    message:
      'dolorMenstrual debe ser alguna de las siguientes opciones: ' +
      dolorMenstrualOpciones,
  })
  ...
  @Matches(/^[A-Z][0-9]{2}(\.[0-9]{1,2})?$/, {
    each: true,
    message:
      'Cada código CIE-10 complementario debe tener el formato A00.0 o A00',
  })
