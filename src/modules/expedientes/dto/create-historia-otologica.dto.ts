...
export class CreateHistoriaOtologicaDto {
  ...
  @Type(() => Date)
  @IsNotEmpty({
    message: 'La fecha de la historia otológica no puede estar vacía',
  })
  ...
  @IsEnum(siONo, {
    message: 'El dolor de oído debe ser uno de los siguientes: ' + siONo,
  })
  dolorOido: string;
  ...
  @IsEnum(siONo, {
    message: 'La supuración de oído debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'El mareo o vértigo debe ser uno de los siguientes: ' + siONo,
  })
  mareoVertigo: string;
  ...
  @IsEnum(siONo, {
    message: 'El zumbido (tinnitus) debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'La pérdida de audición debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(siONo, {
    message:
      'El oído tapado / plenitud debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsString({
    message: 'Las otitis frecuentes en la infancia deben ser un string',
  })
  @IsNotEmpty({
    message: 'Las otitis frecuentes en la infancia no pueden estar vacías',
  })
  @IsEnum(siONo, {
    message:
      'Las otitis frecuentes en la infancia deben ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'Las cirugías de oído deben ser uno de los siguientes: ' + siONo,
  })
  cirugiasOido: string;
  ...
  @IsString({
    message: 'El traumatismo craneal o barotrauma debe ser un string',
  })
  @IsNotEmpty({
    message: 'El traumatismo craneal o barotrauma no puede estar vacío',
  })
  @IsEnum(siONo, {
    message:
      'El traumatismo craneal o barotrauma debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'El uso de audífonos debe ser uno de los siguientes: ' + siONo,
  })
  usoAudifonos: string;
  ...
  @IsString({
    message:
      'La meningitis u otra infección grave en la infancia debe ser un string',
  })
  @IsNotEmpty({
    message:
      'La meningitis u otra infección grave en la infancia no puede estar vacía',
  })
  @IsEnum(siONo, {
    message:
      'La meningitis u otra infección grave en la infancia debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'La diabetes debe ser uno de los siguientes: ' + siONo,
  })
  diabetes: string;
  ...
  @IsEnum(siONo, {
    message: 'La enfermedad renal debe ser uno de los siguientes: ' + siONo,
  })
  enfermedadRenal: string;

  @ApiProperty({
    description:
      'Medicamentos ototóxicos recientes (antibióticos, quimioterapia, diuréticos)',
    enum: siONo,
    example: 'NO',
  })
  @IsString({
    message: 'Los medicamentos ototóxicos recientes deben ser un string',
  })
  @IsNotEmpty({
    message: 'Los medicamentos ototóxicos recientes no pueden estar vacíos',
  })
  @IsEnum(siONo, {
    message:
      'Los medicamentos ototóxicos recientes deben ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsNotEmpty({
    message: 'El trabajo en ambientes ruidosos no puede estar vacío',
  })
  @IsEnum(siONo, {
    message:
      'El trabajo en ambientes ruidosos debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsNotEmpty({
    message: 'El tiempo de exposición laboral no puede estar vacío',
  })
  @IsEnum(tiempoExposicionOpciones, {
    message:
      'El tiempo de exposición laboral debe ser uno de los siguientes: ' +
      tiempoExposicionOpciones,
  })
  ...
  @IsEnum(proteccionAuditivaOpciones, {
    message:
      'El uso de protección auditiva debe ser uno de los siguientes: ' +
      proteccionAuditivaOpciones,
  })
  ...
  @IsString({
    message:
      'La música fuerte / uso prolongado de audífonos debe ser un string',
  })
  @IsNotEmpty({
    message:
      'La música fuerte / uso prolongado de audífonos no puede estar vacía',
  })
  @IsEnum(siONo, {
    message:
      'La música fuerte / uso prolongado de audífonos debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsString({
    message: 'Las armas de fuego / pasatiempos ruidosos deben ser un string',
  })
  @IsNotEmpty({
    message: 'Las armas de fuego / pasatiempos ruidosos no pueden estar vacías',
  })
  @IsEnum(siONo, {
    message:
      'Las armas de fuego / pasatiempos ruidosos deben ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'El servicio militar debe ser uno de los siguientes: ' + siONo,
  })
  ...
  @IsEnum(siONo, {
    message: 'Las alergias deben ser uno de los siguientes: ' + siONo,
  })
  alergias: string;
  ...
  @IsNotEmpty({
    message: 'El resfriado el día de la prueba no puede estar vacío',
  })
  @IsEnum(siONo, {
    message:
      'El resfriado el día de la prueba debe ser uno de los siguientes: ' +
      siONo,
  })
  ...
  @IsEnum(otoscopiaOpciones, {
    message:
      'La otoscopia del oído derecho debe ser uno de los siguientes: ' +
      otoscopiaOpciones,
  })
  ...
  @IsNotEmpty({
    message: 'La otoscopia del oído izquierdo no puede estar vacía',
  })
  @IsEnum(otoscopiaOpciones, {
    message:
      'La otoscopia del oído izquierdo debe ser uno de los siguientes: ' +
      otoscopiaOpciones,
  })
  ...
  @IsString({
    message: 'La ruta del PDF de la historia otológica debe ser un string',
  })
  @IsNotEmpty({
    message: 'La ruta del PDF de la historia otológica no puede estar vacía',
  })
  rutaPDF: string;
