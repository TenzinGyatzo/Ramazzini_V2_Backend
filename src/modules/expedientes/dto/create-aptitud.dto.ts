...
export class CreateAptitudDto {
    ...
    @IsOptional()
    @IsString({ message: 'Resultados de evaluación adicional 1 debe ser un string' })
    ...
    @IsOptional()
    @IsString({ message: 'Resultados de evaluación adicional 3 debe ser un string' })
    ...
    @IsOptional()
    @IsString({ message: 'Resultados de evaluación adicional 4 debe ser un string' })
    ...
    @IsOptional()
    @IsString({ message: 'Resultados de evaluación adicional 5 debe ser un string' })
    ...
    @IsOptional()
    @IsString({ message: 'Resultados de evaluación adicional 6 debe ser un string' })
    ...
    @ApiProperty({
        ...
        example: 'Posterior a efectuar el examen integral de salud ocupacional, se determina que actualmente se encuentra CLÍNICAMENTE APTO CON PRECAUCIÓN PARA LABORAR en las actividades del puesto al que aspira. Cabe señalar que la determinación de la aptitud para el trabajo es solamente clínica, toda vez que no contamos con análisis de laboratorio en este momento.'
    })
