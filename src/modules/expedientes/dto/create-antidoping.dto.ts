...
export class CreateAntidopingDto {
  ...
  @IsEnum(resultado, {
    message: 'El resultado de marihuana debe ser Positivo o Negativo',
  })
  marihuana: string;
  ...
  @IsEnum(resultado, {
    message: 'El resultado de cocaína debe ser Positivo o Negativo',
  })
  cocaina: string;
  ...
  @IsEnum(resultado, {
    message: 'El resultado de anfetaminas debe ser Positivo o Negativo',
  })
  anfetaminas?: string;
  ...
  @IsEnum(resultado, {
    message: 'El resultado de metanfetaminas debe ser Positivo o Negativo',
  })
  ...
  @IsEnum(resultado, {
    message: 'El resultado de opiaceos debe ser Positivo o Negativo',
  })
  opiaceos?: string;
  ...
  @IsEnum(resultado, {
    message: 'El resultado de benzodiacepinas debe ser Positivo o Negativo',
  })
  ...
  @IsEnum(resultado, {
    message: 'El resultado de fenciclidina debe ser Positivo o Negativo',
  })
  fenciclidina?: string;
  ...
  @IsEnum(resultado, {
    message: 'El resultado de metadona debe ser Positivo o Negativo',
  })
  metadona?: string;
  ...
  @IsEnum(resultado, {
    message: 'El resultado de barbituricos debe ser Positivo o Negativo',
  })
  barbituricos?: string;
  ...
  @IsEnum(resultado, {
    message:
      'El resultado de antidepresivosTriciclicos debe ser Positivo o Negativo',
  })
  ...
  @IsEnum(resultado, {
    message:
      'El resultado de metilendioximetanfetamina debe ser Positivo o Negativo',
  })
  ...
  @IsEnum(resultado, {
    message: 'El resultado de ketamina debe ser Positivo o Negativo',
  })
  ketamina?: string;
  ...
  @IsNotEmpty({
    message: 'La ruta del PDF del antidoping no puede estar vacía',
  })
  rutaPDF: string;
