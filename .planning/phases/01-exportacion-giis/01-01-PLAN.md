...
**Objetivo:** Esquema `GiisBatch` en MongoDB; servicio que crea un registro de batch (periodo + proveedor) en estado `pending` o `generating`; sin generación de archivos aún. Verificación: test que crea batch y lee estado.
