...
**Core value:** Que un tenant SIRES pueda exportar información según las 3 guías GIIS aplicables.  
**Current focus:** Fase 3 (UI Exportación GIIS) completada; verificación documentada.

---

## Current Position

- **Milestone:** SIRES_NOM024 (features exclusivas para tenants en régimen SIRES).
- **Roadmap:** 3 phases (Exportación GIIS → GIIS validación externa y entrega regulatoria → UI SIRES generación informes GIIS → …). Ver ROADMAP.md.
